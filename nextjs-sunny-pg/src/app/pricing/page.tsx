    ...
    <div className="bg-white px-6 py-24 sm:py-16 lg:px-8 mt-5">
      ...
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
        <div className="rounded-3xl rounded-t-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-bl-3xl lg:rounded-tr-none">
          ...
          >
            ...
            <li className="flex gap-x-3">
              ...
              Generator Power Backup in case of emergencies
            </li>
            <li className="flex gap-x-3">
              <svg
                className="h-6 w-5 flex-none text-indigo-600"
            ...
            <li className="flex gap-x-3">
              ...
              Furtinures (Almirah, Bed/Cot, Study Table Chair and Lights)
            </li>
          </ul>
          <a
            href="#"
        ...
        <div className="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
          ...
          <ul
            ...
            className="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10"
          >
            <li className="flex text-white gap-x-3">
              <svg
                className="h-6 w-5 flex-none text-indigo-600"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <li className="flex text-white gap-x-3">
              ...
              24x7 Manned and CCTV Camera Security
            </li>
          </ul>
          <a
            href="#"
      ...
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
        ...
        <div className="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
          ...
          <p className="mt-6 text-base/7 text-gray-300">
            Dedicated plan if you wish to continue your stay with us.
          </p>
          <ul
            role="list"
            className="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10"
